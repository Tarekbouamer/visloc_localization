...
class Viewer3D(object):
    ...
    def viewer_init(self, w, h):
        ...
        # Create windows
        pango.CreateWindowAndBind("pySimpleDisplay", w, h)
        ...
        self.proj = pango.ProjectionMatrix(
            w, h, viewpoint_f, viewpoint_f, w//2, h//2, 0.1, 5000)
        self.look_view = pango.ModelViewLookAt(
        ...
        self.dcam.SetBounds(pango.Attach(0), pango.Attach(
            1), pango.Attach.Pix(kUiWidth), pango.Attach(1), -640.0 / 480.0,)
        self.dcam.SetHandler(self.handler)

        # Create Panel
        self.panel = pango.CreatePanel('ui')
        self.panel.SetBounds(pango.Attach(0), pango.Attach(
            1), pango.Attach(0), pango.Attach.Pix(kUiWidth))
